...
def generate_meta_id(
    title: str, creators: str = "", extra: str = "", version: int = 0
) -> str:
...
if __name__ == "__main__":
    ...
    print(
        "True Positives {} out of {}  ({}%)".format(
            true_positives, total, true_positives / total * 100
        )
    )
    ...
    print(
        "False Positives {} out of {} ({}%)".format(
            false_positives, total_meta_ids, false_positives / total_meta_ids * 100
        )
    )
    print()
